...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:97d929a0a2972d6c6bbdbf0e225afa95af99e2ca1c4ccb5d94fd4273c753e759 AS runtime
WORKDIR /app
