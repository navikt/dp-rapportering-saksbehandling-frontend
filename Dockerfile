...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:f0fd78942d466b25f679bf2bec66e8eed0b9380a9c4378b449f5da6f2580fb8e AS runtime
WORKDIR /app
