...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:9c9f6768e6341c0acf5de9bd837fbffc1aad04f86ff267209f6178ba548c4933 AS runtime
WORKDIR /app
