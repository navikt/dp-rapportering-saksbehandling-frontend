...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:cedba740b7cb6f3d6a511820b0b1108175a799b217742828ea1858d068bfe350 AS runtime
WORKDIR /app
