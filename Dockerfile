...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:292d13f3cc09a49f2bcc9464c9a90559acc9c2a9d169a01c84734cd038de52a9 AS runtime
WORKDIR /app
