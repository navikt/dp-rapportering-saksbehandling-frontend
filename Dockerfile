...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:43d48fe49c0cfef2ccedb33b8bf93d058042b93093a9117cc1153148ad65092b AS runtime
WORKDIR /app
