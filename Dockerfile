...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:d6889842907c070cd3660cc4fee7e33cbeda74d29302f9d6b06a77bbd45bc28f AS runtime
WORKDIR /app
