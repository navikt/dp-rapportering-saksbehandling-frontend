...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:5c1b6556a36ada65a4e44253e82ca24ecb9d939ca4551982be85e387be9bfb60 AS runtime
WORKDIR /app
