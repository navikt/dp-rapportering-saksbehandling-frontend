...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:5cadba7a60cbf77ebce241493fb5c86b78bb40ac97f779eb4a06b62ef3e1bd9c AS runtime
WORKDIR /app
