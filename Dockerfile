...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:b816fe93438b92ba9ca0a7346ff7fb48c2e590387c9d3ee308e7d94dcaacd97b AS runtime
WORKDIR /app
