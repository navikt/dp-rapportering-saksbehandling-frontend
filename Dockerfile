...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:ee6f982ddafa045527bf2ca29265e438552c075c3c7634131b0322fec108e520 AS runtime
WORKDIR /app
