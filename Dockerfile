...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:e924a09ee33f5c25008d889a3aefe26e126934deaa613e593eef5dc66a5cf6b0 AS runtime
WORKDIR /app
