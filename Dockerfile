...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:0e7d4737aff2c2a38ffc7591e49269c132eb3375255e7ba5967610fe0624e4b5 AS runtime
WORKDIR /app
