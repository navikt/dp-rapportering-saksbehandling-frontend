...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:b13f0ca031b9f8e8dfaad5e835222517d828896fc76a0d9e070e97c875e30c73 AS runtime
WORKDIR /app
