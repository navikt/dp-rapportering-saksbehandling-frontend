...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:11f2bca111044cf7dc16048ff3b25e68250127cefa821703713bff50b1c3c52c AS runtime
WORKDIR /app
