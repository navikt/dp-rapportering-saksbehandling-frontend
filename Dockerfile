...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:f46c1f593080cedf92595696e84518533dbea8b9f079f031be6af0255361994a AS runtime
WORKDIR /app
