...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:d32140e588ff4876aedc090e3cca9a033ad092fc288b0fc192b58065ec06ba48 AS runtime
WORKDIR /app
