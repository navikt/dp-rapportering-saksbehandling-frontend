...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:017ceee51044f5d124020a244c8cd3e885b36e486f887bfd250413c079ac3a99 AS runtime
WORKDIR /app
