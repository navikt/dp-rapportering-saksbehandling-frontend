...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:ee7deb3602171c983f091f67d60e0990c623bc347088651fad1b2c172e40604d AS runtime
WORKDIR /app
