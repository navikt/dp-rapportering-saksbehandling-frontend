...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:25@sha256:83009f13ef9cfca743c0ca466ecc195075a920504e13fb253762b04fbec9d8f1 AS runtime
WORKDIR /app
